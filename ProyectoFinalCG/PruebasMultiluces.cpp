...
bool Start() {
	...
	material.ambient = glm::vec4(0.2125f, 0.1275f, 0.054f, 1.0f);
	material.diffuse = glm::vec4(0.714f, 0.4284f, 0.18144f, 1.0f);
	material.specular = glm::vec4(0.393548f, 0.271906f, 0.166721f, 1.0f);
